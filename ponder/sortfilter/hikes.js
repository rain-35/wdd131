...
let hikeCards = document.querySelector('#hike-container');
let input = document.querySelector('#search');
let button = document.querySelector('button');

randomNum = Math.floor(Math.random() * hikes.length);
...
function search() {
    ...
    hikeQuery = hikeQuery.toLowerCase();
    ...
    console.log(filteredHikes);
    hikeCards.innerHTML = filteredHikes.map(hikesTemplate).join('');
}
